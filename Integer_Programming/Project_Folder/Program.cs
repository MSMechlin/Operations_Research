        ...
        public class SubproblemNode{
            ...
            */
            public SubproblemNode? BackTrack(){  
                ...
                if(this.fathomed){//Makes sure that current is guaranteed to have children before starting the first loop.
                    current = this.parent;
                }
                if(current == null){
                    return null;
                ...
                //Once an unfathomed node is found climb the tree to the next unfathomed subproblem leaf.
                do{
                ...
                if(arg[0].CompareTo("quit") == 0){
                    ...
                    if(arg[1].CompareTo("constraint") == 0){
                        try{
                            ...
                            Console.WriteLine("File: {0} could not be opened.",arg[2]);
                        }
                    }
                    if(arg[1].CompareTo("objective") == 0){
                        ...
                        objectiveSeen = false;
                            ...
                            Console.WriteLine("File: {0} could not be opened and loaded.",arg[1]);
                        }
                    }   
                }

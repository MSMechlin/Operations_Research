    ...
    public class MainClass{
        ...
        */
        static void Main(String[] args){
            ...
            */
            Tableau? tab = null;
            Vector<double> objective = CreateVector.DenseOfArray<double>(new double[]{6,8});
            ...
            while(quit == false){
                ...
                else if(constraintLoaded && objectiveLoaded){//These conditions imply that tab and objective are not null.
